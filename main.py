    ...
    try:
        ...
        class editVideo:
            ...
            def __init__(self):
                ...
                def speednflip(input, speed, output, xxx):
                    console.log(f"inside speednflip, call VideoFileClip. input="+input)
                    try:
                        VideoFileClip(input)
                        ...
                        f.close()
                    clip = VideoFileClip(input)
                    console.log(f"VideoFileClip called")
                    #audio = AudioFileClip(input)
                    clip = clip.fx(vfx.mirror_x)
                    clip = clip.fx(vfx.speedx, speed)
                    name = clip.filename
                    console.log(f"writing to file")
                    clip.write_videofile(output, verbose= False, logger= None, codec='libx264', audio_codec="aac", preset=xxx)
        ...
        ╚══════╝╚═════╝░╚═╝░░░╚═╝░░░  ░░░╚═╝░░░╚═╝╚═════╝░╚══════╝░╚════╝░
                    ...
                    try:
                        ...
                        print(Box.DoubleCube(os.getcwd()))
                        ...
                        if answers['list'] == ' Flip Horizontal':
                            ...
                            if os.path.exists(video_folder):
                                ...
                                with console.status('[cyan]Processing... please wait!', spinner='line') as status:
                                    ...
                                    if not clip_list:
                                        ...
                                        while True:
                                            counter += 1
                                            dir = os.getcwd()+"/edited/flip/Video{}".format(counter)
                                    ...
                                    # Process files
                                    console.log(f"3 on for clips")
                                    for file in clip_list:
                                        console.log(f"3.1 inside for clips")
                                        output = dir + "/" + file[:-4] + "_edited.mp4"
                                        console.log(f"3.2 inside for clips")

                                        limit = str(f'{file:60.60}')
                                        # Check if output exists in folder. If exists then skip else process
                                        console.log(f"3.3 before path exists")
                                        if os.path.exists(output) == True:
                                            console.log(f"3.4 inside path exists")
                                            console.log(f'[cyan][File][/cyan] [green]{limit}[/green] already exist, skip...')
                                            # function skip
                                            clip_list.remove(file)
                                            console.log(f"3.5 exit path exists")
                                        else:
                                            console.log(f"3.6 inside else of path exists")
                                            start = time.time()
                                            sourceFile = open('logs.txt', 'w')
                                            print(video_folder + "/" + file + ", OUTPUT=" + output +", xxx="+xxx, file = sourceFile)
                                            sourceFile.close()
                                            console.log(f"3.6.1 " + video_folder + "/" + file + ", OUTPUT=" + output +", xxx="+xxx)
                                            #flip1(video_folder + "/" + file, output, xxx)
                                            speednflip(video_folder + "/" + file, 1, output, xxx)
                                            console.log(f"3.7 after flip")
                                            console.log(f'[cyan][File][/cyan] [green]{limit}[/green]')
                                            end = time.time()
                                            console.log(f"3.8 print after flip")
                            ...
                            console.log(f"4 After for clips")
